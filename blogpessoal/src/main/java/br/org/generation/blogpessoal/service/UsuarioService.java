	...
	public Optional<Usuario> atualizarUsuario(Usuario usuario) {
		...
		if (usuarioRepository.findById(usuario.getId()).isPresent()) {
			...
			if (buscaUsuario.isPresent()) {
				...
				/**
				 * Checa se o usuário (email) pertence ao mesmo usuário ou se pertence a outro
				 * usuário através do Id.
				 * 
				 * Caso o usuário seja encontrado na atualização é preciso ter certeza que ele
				 * não esteja cadastrado em outro usuário.
				 */
